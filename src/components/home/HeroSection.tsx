                    ...
                    <div className="col-xxl-7 col-xl-6 col-lg-6">
                        <div className="bd-banner__content-box mb-60">
                            <div className="bd-banner__text">
                                <h2>Pure Organic <br />Cosmetics Shop</h2>
                            </div>
                            <div className="row">
                                ...
                                <div className="col-xxl-6">
                                    ...
                                    <div className="bd-banner__content__wrap">
                                        <div className="bd-banner__content">
                                            <p>Organic Cosmetics include fresh produce, meats, and dairy products as well as processed foods such as fruits frozen meals.</p>
